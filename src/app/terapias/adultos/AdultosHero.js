...
export default function AdultosHero() {
  return (
    <section className="page-hero-split">
      <div className="hero-split-inner">
        ...
        <div className="hero-split-left">
          ...
          <span className="hero-category">PSICOLOGÍA PARA ADULTOS</span>
          ...
          <p className="hero-split-desc">
            Muchas veces no nos sentimos bien y no sabemos por qué. El estrés, las crisis vitales o los conflictos en las relaciones pueden afectarnos profundamente. Quizás solo necesitas a alguien que te acompañe.
          </p>
