...
export default function InfantilHero() {
  return (
    <section className="page-hero-split">
      <div className="hero-split-inner">
        ...
        <div className="hero-split-left">
          ...
          <span className="hero-category">PSICOLOGÍA INFANTIL</span>
          ...
          <p className="hero-split-desc">
            Los niños no siempre tienen palabras para expresar lo que sienten. A través del juego, la creatividad y un vínculo de confianza, acompañamos a tu peque a comprenderse y crecer emocionalmente.
          </p>
